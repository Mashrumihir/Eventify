...
const STATS = [
  {
    ...
    value: '₹45,231',
    change: '+12.5%',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 1v22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>,
    color: 'blue'
  },
  {
    title: 'Tickets Sold',
  ...
  return (
    <div className="org-dash-layout">
      ...
      <div className="org-stats-grid">
        {STATS.map((stat, idx) => (
          <div key={idx} className={`org-stat-card border-${stat.color}`}>
      ...
      <div className="org-charts-row">
        ...
        <div className="org-chart-card">
          ...
          <div className="org-chart-area">
             {/* Using a rough SVG representation matching the line graph in design */}
